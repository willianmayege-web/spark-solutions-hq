...
export const servicesDetail: ServiceDetail[] = [
  ...
  },
  {
    ...
    services: [
      ...
      "Laudo técnico completo com ART para AVCB",
  ...
  },
  {
    ...
    metaTitle: "Laudos Técnicos Elétricos Santa Rosa RS | Perícias",
    metaDescription: "Laudos técnicos elétricos, perícias e inspeções em Santa Rosa RS. Ensaios com megôhmetro, análise de danos elétricos e relatórios periciais.",
    description: "A Eletro May's oferece serviços especializados de laudos técnicos e perícias elétricas para fins judiciais, seguradoras, auditorias e conformidade legal em Santa Rosa e região. Nossos engenheiros eletricistas realizam ensaios técnicos com equipamentos calibrados como megôhmetro Minipa MI-1000A, terrômetro digital MTR-1530 e câmera termográfica. Emitimos laudos de conformidade NBR 5410, análises de danos causados por surtos atmosféricos, perícias em acidentes elétricos, inspeções prediais e avaliações de vida útil de instalações. Todos os relatórios incluem registro fotográfico detalhado, análise técnica fundamentada, conclusões e recomendações, com emissão de ART e reconhecimento judicial.",
    benefits: [
      "Laudos reconhecidos judicialmente com ART",
